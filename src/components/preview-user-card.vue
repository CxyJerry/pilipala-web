...
export default {
  components: {FollowButton, PButton},
  props: {
    user: {
      type: Object,
      default: {
...
<template>
  <div class="container">
    ...
    <div style="display: flex;align-items: center;justify-content: center">
      ...
      <div
        ...
        <svg t="1698170965279" class="icon" viewBox="0 0 1034 1024" version="1.1"
             xmlns="http://www.w3.org/2000/svg" p-id="3884" width="45" height="45">
          <path
    ...
    <div style="display: flex;flex-direction: column;align-items: start;justify-content: center;padding: 10px">
      <div class="nickname" @click="this.$router.push(`/sphere/${this.user.uid}`)">{{ user.nickName }}</div>
      <div style="font-size: small;color: #9b9b9b;padding: 5px">
        <span>粉丝数量</span>
        &nbsp;
        <span>
          {{ user.fansCount }}
