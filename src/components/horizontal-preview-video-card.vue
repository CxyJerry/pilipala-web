  ...
  <div class="feed-card " :class="{'show-card':show_partition}">
    ...
    <div class="feed-img-card" @click="play_bvod">
      <div style="position: relative;width: 100%;height: 100%;">
        ...
        <div style="position:absolute;bottom: 0;width: 100%;display: flex;justify-content: end;padding: 5px">
          <!--    时长    -->
    ...
    <div style="padding-left: 5px;display: flex;flex-direction: column">
      ...
      <div v-show="!show_partition"
           style="position:relative;bottom:0;display: flex;flex-direction: row;justify-content: start;align-items: end;width: 100%;flex: 1">
        <!--     观看数     -->
        <div
